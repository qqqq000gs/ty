...
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "Lucifer_Source")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "LuciferSource")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1424133944").split()))
...
UPSTREAM_REPO = getenv("https://github.com/DeVPHPJS/Lucifer_Music")
